import propertie1 from "../img/properties/properties-range/propertie1.jpeg";
import propertie2 from "../img/properties/properties-range/propertie2.jpeg";
import propertie3 from "../img/properties/properties-range/propertie3.jpeg";

export type PropertiesRangeDataType = {
    name: string;
    img: string;
    description: string;
    features: string[];
...
export const PropertiesRangeData: PropertiesRangeDataType[] = [
    {
