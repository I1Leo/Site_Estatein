...
export const PropertiesData: Array<PropertiesDataType> = [
   {
      name: "Seaside Serenity Villa_1",
      img: "./img/Home/Properties/propertie1.jpeg",
   ...
   },
   {
      ...
      img: "./img/Home/Properties/propertie2.jpeg",
   ...
   },
   {
      ...
      img: "./img/Home/Properties/propertie3.jpeg",
