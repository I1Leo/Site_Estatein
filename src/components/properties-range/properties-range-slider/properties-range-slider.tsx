...
import type { TPropertiesSlider } from "../../../types/properties/properties-range-slider";
import PurpleBtn from "../../generic/purple-btn/purple-btn";
import s from "./properties-range-slider.module.scss";
import PropertiesFeature from "../properties-range-feature/properties-range-feature";
import SliderItem from "../../generic/slider/slider-item/slider-item";
import Slider from "../../generic/slider/slider";
import { useWindowWidth } from "../../../hooks";

export default function PropertiesSlider({ data }: TPropertiesSlider) {
