import type { TSearch } from "../../types/properties/search";
import PurpleBtn from "../generic/purple-btn/purple-btn";
import s from "./Search.module.scss";
import SearchItem from "./search-item/search-item";

export default function Search({ data }: TSearch) {
            ...
            <div className={s.container}>
                <div className={s.wrapper}>
                    ...
                    <p className={s.text}>
                        ...
                        beautiful world. Explore our curated selection of properties, each offering
                        a unique story and a chance to redefine your life. With categories to suit
