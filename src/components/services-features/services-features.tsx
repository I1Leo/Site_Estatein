...
import icon1 from "../../img/services/features/icon-1.svg";
import icon2 from "../../img/services/features/icon-2.svg";
import icon3 from "../../img/services/features/icon-3.svg";
import icon4 from "../../img/services/features/icon-4.svg";
